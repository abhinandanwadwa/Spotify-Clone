    ...
    <>
        <div className="sidebar fixed left-0 bg-[#121212] text-white h-[82vh] p-5 w-[19%] rounded-lg mx-2">
            ...
            <ul className='space-y-2'>
                ...
                {/* <svg role="img" height="12" width="12" aria-hidden="true" viewBox="0 0 16 16" className="Svg-ytk21e-0 jAKAlG collection-icon"><path d="M15.25 8a.75.75 0 01-.75.75H8.75v5.75a.75.75 0 01-1.5 0V8.75H1.5a.75.75 0 010-1.5h5.75V1.5a.75.75 0 011.5 0v5.75h5.75a.75.75 0 01.75.75z"></path></svg> */}
